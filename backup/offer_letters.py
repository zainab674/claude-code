...
POST /offer-letters   generate a PDF offer letter for a candidate
GET  /offer-letters/{id}  download the PDF

Uses ReportLab — no external API needed.
"""
import uuid
import os
...
# In-memory store of generated offers (use DB in production)
_offers: dict = {}
